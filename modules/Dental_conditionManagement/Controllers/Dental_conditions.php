<?php
namespace Modules\Dental_conditionManagement\Controllers;
...
class Dental_conditions extends BaseController
{
    ...
    public function index($offset = 0)
    {
        ...
        $data['viewName'] = 'Modules\Dental_conditionManagement\Views\dental_conditions\index';
    ...
    public function show_dental_condition($id)
	{
        ...
        $data['viewName'] = 'Modules\Dental_conditionManagement\Views\dental_conditions\dental_conditionDetails';
        echo view('App\Views\theme\index', $data);
	}
    ...
    public function add_dental_condition()
    {
    	...
    	if(!empty($_POST))
    	{
	    	if (!$this->validate('dental_condition'))
		    {
		        ...
		        $data['viewName'] = 'Modules\Dental_conditionManagement\Views\dental_conditions\frmDental_condition';
		        echo view('App\Views\theme\index', $data);
		    }
		    else
		    {
