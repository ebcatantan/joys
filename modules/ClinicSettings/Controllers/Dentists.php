...
use Modules\ClinicSettings\Models\DentistsModel;
...
class Dentists extends BaseController
{
    ...
    public function index($offset = 0)
    {
        ...
        $data['viewName'] = 'Modules\ClinicSettings\Views\dentists\index';
        echo view('App\Views\theme\index', $data);
    }

    public function show_dentist($id)
	{
		$this->hasPermissionRedirect('show-dentist');
        ...
        $data['viewName'] = 'Modules\ClinicSettings\Views\dentists\dentistDetails';
        echo view('App\Views\theme\index', $data);
	}
    ...
    public function add_dentist()
    {
    	...
    	if(!empty($_POST))
    	{
	    	if (!$this->validate('dentists'))
		    {
		        ...
		        $data['viewName'] = 'Modules\ClinicSettings\Views\dentists\frmDentist';
		        echo view('App\Views\theme\index', $data);
		    }
		    else
		    {
