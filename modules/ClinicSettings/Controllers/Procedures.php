...
use Modules\ClinicSettings\Models\ProceduresModel;
...
class Procedures extends BaseController
{
    ...
    public function index($offset = 0)
    {
        ...
        $data['viewName'] = 'Modules\ClinicSettings\Views\procedures\index';
    ...
    public function show_procedure($id)
	{
        ...
        $data['viewName'] = 'Modules\ClinicSettings\Views\procedures\procedureDetails';
        echo view('App\Views\theme\index', $data);
	}
    ...
    public function add_procedure()
    {
    	...
    	if(!empty($_POST))
    	{
	    	if (!$this->validate('procedure'))
		    {
		        ...
		        $data['viewName'] = 'Modules\ClinicSettings\Views\procedures\frmProcedure';
		        echo view('App\Views\theme\index', $data);
		        //die("here");
		    }
		    else
