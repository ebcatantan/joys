...
use Modules\Inventory\Models\MedicinesModel;
...
class Medicines extends BaseController
{
	...
	public function show_medicine($id)
	{
        ...
        $data['viewName'] = 'Modules\Inventory\Views\medicines\medicineDetails';
  ...
  //       echo view('App\Views\theme\index', $data);
    ...
    public function index($offset = 0)
    {
        ...
        $data['viewName'] = 'Modules\Inventory\Views\medicines\index';
        echo view('App\Views\theme\index', $data);
    }
    ...
    public function add_medicine()
    {
    	...
    	if(!empty($_POST))
    	{
	    	if (!$this->validate('medicine'))
		    {
		        ...
		        $data['viewName'] = 'Modules\Inventory\Views\medicines\frmMedicine';
		        echo view('App\Views\theme\index', $data);
		    }
		    else
		    {
