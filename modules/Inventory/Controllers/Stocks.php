...
use Modules\Inventory\Models\StocksModel;
...
class Stocks extends BaseController
{
    ...
    public function index($offset = 0)
    {
        ...
        $data['viewName'] = 'Modules\Inventory\Views\stocks\index';
		...
		$data['function_title'] = "Stock Details";
				$data['viewName'] = 'Modules\Inventory\Views\stocks\stocksDetails';
				echo view('App\Views\theme\index', $data);
		}
  //   public function show_supply_stocks($id)
	// {
		...
		if(!empty($_POST))
		{
			if (!$this->validate('stocks'))
			{
				$data['errors'] = \Config\Services::validation()->getErrors();
					...
					$data['viewName'] = 'Modules\Inventory\Views\stocks\frmStocks';
					echo view('App\Views\theme\index', $data);
			}
			else
			{
