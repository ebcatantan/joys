<?php
namespace Modules\MedicineAllergiesManagement\Controllers;

use Modules\MedicineAllergiesManagement\Models\AllergiesModel;
...
class Allergies extends BaseController
{
    ...
    public function index($offset = 0)
    {
        ...
        $data['viewName'] = 'Modules\MedicineAllergiesManagement\Views\medicine\index';
    ...
    public function show_medicine_allergies($id)
	{
        ...
        $data['viewName'] = 'Modules\MedicineAllergiesManagement\Views\medicine\MedicineAllergiesDetails';
        echo view('App\Views\theme\index', $data);
	}
    ...
    public function add_medicine_allergies()
    {
    	...
    	if(!empty($_POST))
    	{
	    	if (!$this->validate('allergies'))
		    {
		        ...
		        $data['viewName'] = 'Modules\MedicineAllergiesManagement\Views\medicine\frmAllergies';
		        echo view('App\Views\theme\index', $data);
		    }
		    else
		    {
